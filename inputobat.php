...
<? include"waktu.php";?>
	...
	<form method="post" action="aksi_obat.php" onsubmit="MM_validateForm('kdobat','','R','nama','','R','jenis','','R','stok','','R');return document.MM_returnValue">
  ...
  <tr>
    <td colspan="3" style="font-size:14px; padding-top:0px;" align="center" height="30" valign="top"> Form Input Obat </td>
    </tr>
  <tr>
    <td>Kode Obat</td>
    <td>:</td>
    <td><input name="kdobat" type="text" id="kdobat" size="10" maxlength="10" />
</td>
  </tr>  <tr>
    <td>Nama Obat</td>
    <td>:</td>
