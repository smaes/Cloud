...
var ImageURL = './kalender/images/calendarIcon.jpg';
var NextURL = './kalender/images/calendarNext.gif';
var PrevURL = './kalender/images/calendarPrev.gif';
...
function DayCellHover(Cell, Over, Color, HoveredDay) {
   ...
   if (Over) {
      if ((this.yearValue == Today1.getFullYear()) && (this.monthIndex == Today1.getMonth()) && (HoveredDay == Today1.getDate())) self.status = 'Click to select today1';
      else {
   ...
   for (var j=0;j<Rows;j++) {
      ...
      for (var i=1;i<=7;i++) {
         ...
         if ((Day >= 1) && (Day <= this.displayed.dayCount)) {
            ...
            if ((this.displayed.yearValue == Today1.getFullYear()) && (this.displayed.monthIndex == Today1.getMonth()) && (Day == Today1.getDate())) TextStyle += 'border:1px solid darkred;padding:0px;';
...
function displayMonthObject(ParentObject, DateYear, DateMonth, DateDay) {
   ...
   this.goCurrent = new Function(ParentObject.objName + '.getCalendar().style.zIndex=++ZCounter;' + ParentObject.objName + '.setDisplayed(Today1.getFullYear(),Today1.getMonth());');
...
function calendarObject(DateName, DateFormat, DefaultDate) {
   ...
   function SetGoodDate(CalObj, Notify) { // Notifies the user about their bad default date, and sets the current system date
      CalObj.setPicked(Today1.getFullYear(), Today1.getMonth(), Today1.getDate());
   ...
   if (arguments.length == 0) document.writeln('<span style="color:red;font-size:' + FontSize + 'px;font-family:' + FontFamily + ';">ERROR: Missing required parameter in call to \'DateInput\': [name of hidden date field].</span>');
      ...
      if (arguments.length < 3) { // The format wasn't passed in, so use default
         ...
         if (arguments.length == 4) { // DefaultDate was passed in with an invalid date format
            var CurrentDate = new storedMonthObject(DateFormat, Today1.getFullYear(), Today1.getMonth(), Today1.getDate());
      ...
      if (!CurrentDate) var CurrentDate = new storedMonthObject(DateFormat, Today1.getFullYear(), Today1.getMonth(), Today1.getDate());
      // Handle DefaultDate
      ...
      if ((Required) || (arguments.length == 4)) {
         ...
         var InitialDate = '';
         eval(DateName + '_Object.setPicked(' + Today1.getFullYear() + ',' + Today1.getMonth() + ',' + Today1.getDate() + ')');
      }
