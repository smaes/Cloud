...
<? include"waktu.php";?>
	...
	<form method="post" action="aksi_sales.php" onsubmit="MM_validateForm('nama','','R','idsales','','R','password','','R','password1','','R','alamat','','R');return document.MM_returnValue">
  ...
  <tr>
    <td colspan="3" style="font-size:14px; padding-top:0px;" align="center" height="30" valign="top"> Form Input Salesman </td>
    </tr>
  <tr>
    <td>Id Salesman</td>
    <td>:</td>
    <td><input name="idsales" type="text" id="idsales" size="20" />
</td>
  </tr>
  <tr>
    <td>Nama</td>
    <td>:</td>
    <td><input name="nama" type="text" id="nama" size="20" maxlength="20" />
</td>
  </tr>
  <tr>
    <td>Password</td>
  ...
  <tr>
    <td>Alamat</td>
    <td>:</td>
    <td><textarea name="alamat" id="alamat" cols="20" rows="5"></textarea>
</td>
  </tr>
  ...
  <tr>
    <td>Jenis Kelamin</td>
    <td>:</td>
    <td><input type="radio" name="jk" value="Laki-laki" checked="checked" />Laki-laki <input type="radio" name="jk" value="Perempuan" />Perempuan
</td>
  </tr>
